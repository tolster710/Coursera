...
def find_events(ls_symbols, d_data,criteria):
    ...
    for i in range(1, len(ldt_timestamps)):
        for s_sym in ls_symbols:
            ...
            if f_symprice_today<=criteria and f_symprice_yest>criteria:
            	df_events[s_sym].ix[ldt_timestamps[i]] = 1    
    return df_events
...
if __name__ == '__main__':
    ...
    #
    df_events = find_events(ls_symbols, d_data,criteria)
